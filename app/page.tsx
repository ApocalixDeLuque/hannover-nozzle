...
import { Box, Cog, Mail, ChevronDown, PencilRuler, Zap } from 'lucide-react';
      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-light to-muted uppercase">
        <header className="fixed w-full z-50 bg-light/80 backdrop-blur-md">
          <div className="flex px-5 py-4 lg:px-10 items-center justify-between">
            <div onClick={() => lenis?.scrollTo(0)} className="flex items-center space-x-2 normal-case cursor-pointer">
              <LogoIcon className="h-8 w-8 md:h-10 md:w-10 text-dark" />
              <span className="text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-dark">Translate3D</span>
            </div>
        ...
        <main className="flex-grow pt-16">
          <section className="h-screen flex items-center justify-center relative overflow-hidden">
            <motion.div style={{ opacity, scale }} className="text-center z-10 px-4">
              ...
              <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-light normal-case">
                Transforma tus ideas en realidad con nuestra tecnología de impresión 3D de vanguardia.
              </p>
          ...
          <section id="services" className="py-20">
            <div className="flex flex-col px-5 gap-2 lg:gap-4 lg:px-10">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 animate-on-scroll">Nuestros Servicios</h2>
          ...
          <section id="products" className="py-20 bg-muted">
            <div className="flex flex-col items-center px-5 gap-2 lg:gap-4 lg:px-10">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 animate-on-scroll">Nuestros Productos</h2>
          ...
          <section className="p-5 lg:p-10 bg-light text-dark">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 animate-on-scroll">Creado por nosotros</h2>
          ...
          <section id="subscribe" className="py-20">
            <div className="flex flex-col items-center px-5 gap-2 lg:gap-4 lg:px-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-8 animate-on-scroll">Mantente Informado</h2>
              <p className="mb-8 text-lg md:text-xl max-w-2xl mx-auto">
                Sé el primero en conocer las últimas novedades sobre nuestro evento y el lanzamiento de nuestro sitio
                web.
              </p>
              <form
              ...
              >
                ...
                />
                <Button type="submit" variant={'primary'} disabled={!email} className="w-full sm:w-auto">
                  Suscribirse <Mail className="h-4 w-4 ml-2" />
                </Button>
              </form>
            </div>
          </section>
          ...
          <div className="flex flex-col items-center px-5 lg:px-10">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 pb-10 border-b border-gray-200">
              <div className="flex flex-col gap-1">
                ...
                >
                  <LogoIcon className="h-8 w-8 md:h-10 md:w-10 text-light" />
                  <span className="text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-light">
                    Translate3D
                  </span>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="text-sm">contacto@translate3d.tech</li>
                  <li className="text-sm">+52 464 123 1975</li>
                </ul>
              </div>
              <div>
            ...
            <div className="flex flex-col gap-5 pt-10 text-center">
              ...
              <Link href="https://www.nightly.software" className="font-semibold text-sm text-light hover:text-primary">
...
function FeatureCard({ title, description }: { title: string; description: string }) {
  return (
    <motion.div
      whileHover={{ scale: 1.05 }}
      className="bg-light text-dark p-6 rounded-lg shadow-lg text-center animate-on-scroll"
    >
